# Changelog — Vardot/drupal-core-patches (`10.4.x`)

All notable changes on the `10.4.x` branch of [`Vardot/drupal-core-patches`](https://github.com/Vardot/drupal-core-patches), newest first.
...
- docs: Add `CHANGELOG.md` for the `10.4.x` branch (#4)
...
- Initial tracked release on the `10.4.x` branch.
