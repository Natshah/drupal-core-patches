# Changelog — Vardot/drupal-core-patches (`11.4.x`)

All notable changes on the `11.4.x` branch of [`Vardot/drupal-core-patches`](https://github.com/Vardot/drupal-core-patches), newest first.
