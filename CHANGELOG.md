# Changelog — Vardot/drupal-core-patches (`12.0.x`)

All notable changes on the `12.0.x` branch of [`Vardot/drupal-core-patches`](https://github.com/Vardot/drupal-core-patches), newest first.
