# Changelog — Vardot/drupal-core-patches (`11.2.x`)

All notable changes on the `11.2.x` branch of [`Vardot/drupal-core-patches`](https://github.com/Vardot/drupal-core-patches), newest first.
...
- docs: Add `CHANGELOG.md` for the `11.2.x` branch (#8)
...
- Initial tracked release on the `11.2.x` branch.
